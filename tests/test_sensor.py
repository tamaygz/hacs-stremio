...
class TestCurrentWatchingSensor:
    ...
    @pytest.mark.asyncio
    async def test_sensor_state_idle(self, mock_hass, mock_coordinator, mock_config_entry):
...
class TestContinueWatchingCountSensor:
    ...
    def continue_watching_sensor(self, mock_sensor_coordinator, mock_config_entry):
        ...
        description = next(d for d in SENSOR_TYPES if d.key == "continue_watching_count")
        sensor = StremioSensor(mock_sensor_coordinator, mock_config_entry, description)
        return sensor
...
class TestSensorDeviceInfo:
    ...
    @pytest.mark.asyncio
    async def test_device_info(self, mock_hass, mock_sensor_coordinator, mock_config_entry):
    ...
    @pytest.mark.asyncio
    async def test_unique_id(self, mock_hass, mock_sensor_coordinator, mock_config_entry):
...
class TestSensorIcons:
    ...
    @pytest.mark.asyncio
    async def test_current_watching_icon(self, mock_sensor_coordinator, mock_config_entry):
